// my first api call using FREE API KEYS to connect with another 
// server
...
const WEATHER_API_KEY = "6ac4164257ae4822847212350240407"
const baseUrl = `/api`
...
app.get(`${baseUrl}/hello`, async (req, res) => {
    try {
        ...
        const { data } = await axios.get(`${weatherApiBaseUrl}/current.json`, {
            params: {
                key,
                q: req.headers["x-forwarded-for"] || req.socket.remoteAddress
            }
        })
